...
export default function ContractPrintPage() {
  ...
  const vatAmount = isVatRegistered ? totalDue - (totalDue / 1.15) : 0;
  const subtotalExVat = isVatRegistered ? totalDue / 1.15 : totalDue;
    ...
    <div className="min-h-screen bg-zinc-100 py-8 font-sans text-zinc-900 print:bg-white print:py-0">
      ...
      <div className="mx-auto max-w-[800px] bg-white p-12 shadow-xl print:m-0 print:max-w-none print:shadow-none sm:rounded-lg">
        ...
        <div className="mb-12 flex items-start justify-between">
          <div>
            ...
            <div className="mt-3 text-sm leading-relaxed text-zinc-600">
              ...
              <p>VAT: {company.vat_number || "4890123456"}</p>
          ...
          <div className="text-right">
            ...
            <div className="mt-4 grid grid-cols-2 gap-x-4 gap-y-1 text-sm text-right">
              <span className="font-semibold text-zinc-500">Contract ID:</span>
        ...
        <div className="mb-10 grid grid-cols-2 gap-10">
          <div>
            <h3 className="mb-2 text-xs font-bold uppercase tracking-widest text-zinc-400">Client</h3>
          ...
          <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
            <h3 className="mb-2 text-xs font-bold uppercase tracking-widest text-zinc-400">Agreement Details</h3>
            <p className="text-sm text-zinc-700">{contract.details || "No special terms specified."}</p>
          </div>
        </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-zinc-100">
              {lineItems.map((item, index) => (
                <tr key={index}>
                  <td className="px-4 py-3.5 font-medium text-zinc-900">{item.skip_size} Heavy Duty Skip</td>
        ...
        <div className="flex justify-end">
          <div className="w-1/2 min-w-[250px]">
            {isVatRegistered && (
              <>
                <div className="flex justify-between border-b border-zinc-100 py-2 text-sm text-zinc-600">
                  ...
                  <span className="font-mono">{zar.format(subtotalExVat)}</span>
                </div>
            ...
            <div className="flex justify-between py-3 text-lg font-black text-cyan-700">
        ...
        <div className="mt-16 border-t border-zinc-200 pt-8">
          ...
          <p className="mt-8 text-center text-sm font-bold text-cyan-600">
